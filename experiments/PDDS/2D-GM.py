...
# # Easy 2D Gaussian Mixture Example
...
CONFIG = {
    # Problem dimensions
    "dim": 2,
    "mean_scale": 1,  # Scale parameter for the Gaussian mixture
    "sigma": 1.0,
    "t_0": 0.0,
    "t_f": 1.0,
...
def setup_problem(config):
    """
    Sets up the core components of the PDDS problem for Gaussian mixture.
    
    Returns:
        tuple: (target_distribution, sde, log_g0, mcmc_step_size_scheduler)
    """
    # Target distribution - Challenging 2D Gaussian mixture
...
# Extract ESS history if available
naive_ess_history = naive_smc_result.get("ess_history", None)
...
# Extract ESS history if available
nn_ess_history = nn_smc_result.get("ess_history", None)
...
print("=" * 80)
print("PDDS Sampling for 2D Gaussian Mixture Experiment Summary")
print("=" * 80)
...
"""
Easy 2D Gaussian mixture with moderate separation (mean_scale=1)
...
Results:
Naive potential log Z: -0.4994 ± 0.4642
NN potential log Z: -0.0093 ± 0.0559
Improvement: 0.4900

Conclusion:
Standard PDDS is sufficient for Easy 2D Gaussian mixture
"""
# -