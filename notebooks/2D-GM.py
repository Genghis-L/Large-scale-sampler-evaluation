...
# # Challenging Gaussian Mixture Example
...
# Plot 2D scatter
axs[0, 0].scatter(target_samples[:, 0], target_samples[:, 1], alpha=0.5, label="Target", s=10)
axs[0, 0].scatter(final_samples[idx, 0], final_samples[idx, 1], alpha=0.5, label="PDDS", s=10)
axs[0, 0].set_title(f"2D Gaussian Mixture (mean_scale={mean_scale})")
axs[0, 0].set_xlabel("x")
axs[0, 0].set_ylabel("y")
axs[0, 0].legend()
...
# Plot 1D marginal x-axis
sns.kdeplot(target_samples[:, 0], label="Target", ax=axs[0, 1])
sns.kdeplot(final_samples[:, 0], label="PDDS", ax=axs[0, 1])
axs[0, 1].set_title("1D Marginal (x-axis)")
axs[0, 1].set_xlabel("x")
axs[0, 1].legend()
...
sns.kdeplot(final_samples[:, 1], label="PDDS", ax=axs[0, 2])
...
axs[1, 2].hist(final_samples[:, 0], bins=30, alpha=0.5, label="PDDS X", density=True)
...
# Plot 1D marginal y-axis
sns.kdeplot(target_samples[:, 1], label="Target", ax=axs[1, 0])
sns.kdeplot(final_samples[:, 1], label="PDDS", ax=axs[1, 0])
axs[1, 0].set_title("1D Marginal (y-axis)")
axs[1, 0].set_xlabel("y")
axs[1, 0].legend()
